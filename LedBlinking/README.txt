...
Task 4 (do): In this one, switch sw2 acts as an "enter". Switch sw1 lets us enter 0 or 1 at a time. It is a serial line. If we enter 010011, it means 010=2 011=3. 010 is B (A=001, B=010, C=011, D=100). 010 011 means B3. As a result B3 starts blinking.
